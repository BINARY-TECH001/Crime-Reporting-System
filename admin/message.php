    ...
    <body>
        ...
        <div class="panel-body">
                ...
                <tr>
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"select *from `contact` ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                            <a href="de.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-times"></span> Remove</a>
                              </td>
                          </tr>
                          <?php
